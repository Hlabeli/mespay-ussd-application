...
import com.mespay.core.constants.IAppConstant;
import com.mespay.core.exceptions.CustomException;
...
import static com.mespay.core.constants.IAppConstant.DateFormatters.DATE_TIME_FORMATTER;
import static com.mespay.core.constants.IAppConstant.DateFormatters.timeFormat;
...
public class AppUtils {
    ...
    public static Timestamp parseDate(String dateStr) {
        ...
        try {
            return new Timestamp(IAppConstant.DateFormatters.dateFormat.parse(dateStr).getTime());
