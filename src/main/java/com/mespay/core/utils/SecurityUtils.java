...
import static com.mespay.core.constants.IAppConstant.SecurityConstants.*;
...
public class SecurityUtils {
    ...
    private static String decryption(String textS, String secretKey) {
        try {
            ...
            byte[] dec = Base64.decodeBase64(Arrays.toString(input.getBytes(StandardCharsets.UTF_8)));
